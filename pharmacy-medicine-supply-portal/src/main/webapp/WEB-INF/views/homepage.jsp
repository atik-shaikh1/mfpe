	...
	<div class="row">
		...
		<div class="col">
			<div class="card bg-light text-center" style="width: 18rem;">
				<img class="card-img-top" src="https://cdn.dribbble.com/users/2526497/screenshots/6175813/image.png"
					alt="img medical representative">
				<div class="card-body">
		...
		<div class="col">
			<div class="card bg-light text-center" style="width: 18rem;">
				<img class="card-img-top" src="https://www.webretailer.com/wp-content/uploads/2018/08/Busy-warehouse.jpg"
					alt="img medicine stock">
				<div class="card-body">
